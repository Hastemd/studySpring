package com.example.lijie.testConcurrent.jiamijiemi;
...
/**
 * auther lijie  2018/8/11.
 */
public class XueyuanEncoder {
    ...
    public static void main(String[] args) {
       ...
       /*
        ...
        String encodeRules="307";
        System.out.println("使用AES对称加密，请输入加密的规则:"+encodeRules);

        String content = "15995619302";
        System.out.println("请输入要加密的内容:"+content);
        content=se.AESEncode(encodeRules, content);
